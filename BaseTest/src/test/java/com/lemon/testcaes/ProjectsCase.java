	...
	private Logger log =  Logger.getLogger(ProjectsCase.class);
	  ...
	  public void project(RequestType type,RequestCase casedata) {
		 ...
		 // String assertResult =(responseAssert && sqlAssert)? "Pass" : "Fail";
		  ...
		  log.info("========================ProjectsCase最终断言结果：" + assertResult);
	  ...
	  @DataProvider
	  public Object[][] datas() {	
		  Object[][] objects = UnionCase.getAPIAndCaseByAPIId("4");
		  return objects;
